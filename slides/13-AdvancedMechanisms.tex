...
\begin{frame}[fragile,shrink=5]\frametitle{Classi innestate statiche -- accesso}
  \bl{Uso}{\iz{
    ...
    \item Esterna e interna si vedono mutuamente le proprietà \cil{private} {\iz{
        \item ossia il significato completo di \cil{private} è: 
        \item ``privato a livello della outerclass più esterna''
    }}
  }}
\begin{lstlisting}
class Outer {
...
\fr{Classe \Cil{Counter} e specializzazioni innestate (1/2)}{
  \sizedcode{\scriptsize}{13/code/nested/Counter_.java}
}

\fr{Classe \Cil{Counter} e specializzazioni innestate (2/2)}{
  \sizedcode{\scriptsize}{13/code/nested/Counter_2.java}
}
...
\fr{Classe \Cil{Range} e suo iteratore (1/2)}{
  \sizedcode{\scriptsize}{13/code/nested/Range_.java}
}

\fr{Classe \Cil{Range} e suo iteratore (2/2)}{
  \sizedcode{\scriptsize}{13/code/nested/Range_2.java}
}
...
\fr{\Cil{Map}}{
  \sizedcode{\scriptsize}{13/code/short/Map_.java}
}

%\fr{Usare le mappe}{
%  \sizedcode{\ssmall}{13/code/map/UseMap.java}
%}

\fr{Implementazione mappe -- UML}{
    \fg{height=0.75\textheight}{13/img/uml-abs.pdf}
}
...
\bl{Ruolo di \cil{Map.Entry}}{\iz{
  ...
  \sizedcode{\scriptsize}{13/code/short/Map_2.java}
}
...
\fr{Soluzione alternativa, \Cil{Persona}: 1/2}{
  \sizedcode{\ssmall}{13/code/enums/PersonaBis_1.java}
}

\fr{Soluzione alternativa \Cil{Persona}: 2/2}{
  \sizedcode{\ssmall}{13/code/enums/PersonaBis_2.java}
}

\fr{Soluzione alternativa \Cil{UsePersona}}{
  \sizedrangedcode{\ssmall}{3}{100}{13/code/enums/UsePersonaBis.java}
}

\fr{Soluzione con polimorfismo e ereditarietà}{
  \sizedrangedcode{\ssmall}{3}{100}{13/code/enums/Regione.java}
}
...
\fr{\Cil{enum Regione}}{
  \sizedcode{\scriptsize}{13/code/enums2/Regione.java}
