...
\newcommand{\ecl}{\eclipsepath{p17lambda}}
...
\frs{5}{Interfacce \Cil{Iterator} e \Cil{Iterable} complete}{
    \sizedrangedcode{\tiny}{1}{100}{17/snippets/Iterable.java}
    \sizedrangedcode{\tiny}{1}{100}{17/snippets/Iterator.java}
}
...
\fr{Interfaccia \Cil{java.util.Map} -- metodi aggiuntivi}{
    \sizedrangedcode{\tiny}{1}{100}{17/snippets/Map.java}
}
...
\fr{Classe \Cil{java.util.Optional}}{
    \sizedrangedcode{\tiny}{1}{100}{17/snippets/Optional.java}
}
