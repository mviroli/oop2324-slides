...
\fr{Java array}{
  ...
  \item È impossibile violare i limiti di una array, pena un errore a tempo di esecuzione (\cil{ArryIndexOutOfBoundsException})
  \item L'accesso ad un array è di conseguenza leggermente rallentato, in linea di principio, rispetto al caso del C
  }}
}
...
\section{Un addendum: sula qualità del software\dots}
