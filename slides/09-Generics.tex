...
\fr{Un esempio: \Cil{IntVector}}{
  ...
  \fg{height=0.6\textheight}{09/img/uml-int-vector-abstracted.pdf}
}
...
\fr{\Cil{IntVector} -- implementazione}{
  ...
  \fg{height=0.6\textheight}{09/img/uml-int-vector.pdf}
}
...
\fr{Da \Cil{IntVector} a \Cil{ObjectVector}}{
  \fg{height=0.6\textheight}{09/img/uml-obj-vector.pdf}
}
...
\fr{Implementazione di \Cil{Vector} pt 1}{
  \sizedcode{\scriptsize}{09/code/VectorA.java}
}

\fr{Implementazione di \Cil{Vector} pt 2}{
  \sizedcode{\scriptsize}{09/code/VectorB.java}
}
...
\fr{Esempio di metodo generico in classe generica}{
  \sizedcode{\ssmall}{09/code/UseGenMeth.java}
}

\fr{Notazione UML: non del tutto standard}{
  \fg{height=0.8\textheight}{09/img/uml-generics.pdf}
}
