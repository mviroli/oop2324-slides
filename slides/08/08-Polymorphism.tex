...
\title[OOP08: Polimorfismo]{08 \\ Polimorfismo (inclusivo, con le classi)}

\begin{document}

\newcommand{\ecl}{\idepath{p08polymorphism}}
...
\frs{25}{Come simulare ereditarietà multipla?}{
  ...
  \bl{Complessivamente}{\iz{
    ...
    \item p.e.: \cil{BiCounter bc = new BiAndMultiCounterImpl(); // OK}
...
\fr{Autoboxing dei tipi primitivi}{
  \bl{Ancora sui Wrapper dei tipi primitivi}{\iz{
    \item \cil{Integer i = Integer.valueOf(10);}
    \item \cil{Double d = Double.valueOf(10.5);}
