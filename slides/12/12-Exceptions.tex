...
\newcommand{\ecl}{\idepath{p12exceptions}}
\newcommand{\ecls}{\idepath{p12exceptions/safedevices}}
...
\fr{\Cil{catch} multipli e \Cil{finally}}{
  \sizedrangedcode{\scriptsize}{3}{30}{\ecl/classes/UseRange3.java}
}
...
\fr{\Cil{catch} multiplo con ``alternative types''}{
  \sizedrangedcode{\scriptsize}{3}{30}{\ecl/classes/UseRange4.java}
}
...
\fr{Input da tastiera senza eccezioni)}{
...
\fr{Best practice con le eccezioni}{
  \bl{Che ricapitoleremo e discuteremo a fine corso}{\iz{
    \item i metodi pubblici controllino subito la validità degli input, lanciando eccezioni unchecked per segnalare il ``bug'' 
    \item si riusino in via prioritaria le eccezioni delle librerie Java 
    \item se un problema non è dovuto a bug, sarebbe meglio non lanciare eccezioni, ma fornire un output che rappresenta l'anomalia
  }}
}
