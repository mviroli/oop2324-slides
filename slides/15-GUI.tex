...
\newcommand{\ecl}{\eclipsepath{p15gui}}
...
\fr{AWT e Swing: UML}{
    \fg{height=0.85\textheight}{15/img/swing.png}
}
...
\fr{Concetti principali}{
    \fg{height=0.75\textheight}{15/img/swing-comps.pdf}
}


\fr{Un primo esempio}{
    \sizedrangedcode{\ssmall}{3}{100}{\ecl/examples/TrySwing.java}
    \backpick{4cm}{-2cm}{-1.5cm}{15/img/TrySwing.png}
}

\fr{Vari \Cil{JComponent} disponibili..}{
    \sizedrangedcode{\ssmall}{3}{100}{\ecl/examples/Components.java}
    \backpick{7cm}{-3.2cm}{-1.3cm}{15/img/Components.png}
}

\fr{Classi di Swing}{
    \fg{height=0.85\textheight}{15/img/swing-details.png}
}
...
\fr{Senza Layout -- deprecabile}{
   ...
   \backpick{5cm}{-2.2cm}{-1.2cm}{15/img/NoLayout.png}
}


\fr{\Cil{BorderLayout}}{
   \sizedrangedcode{\ssmall}{3}{100}{\ecl/examples/UseBorderLayout.java}
   \backpick{5cm}{-2.2cm}{-1.2cm}{15/img/BorderLayout.png}
}
...
\fr{Lavorare incapsulando il frame dietro una interfaccia}{
   ...
   \bl{Tipica tecnica}{\iz{
    \item si disegni una interfaccia pulita per la GUI
...
\fg{height=0.5\textheight}{15/img/observer.jpg}
\bx{\iz{
...
\fr{Catturare gli eventi dei pulsanti con \Cil{ActionCommand}}{
   ...
   \backpick{4cm}{-2.4cm}{-1.8cm}{15/img/actions.png}
}
...
\fr{Panoramica eventi-listeners}{
    \fg{height=0.75\textheight}{15/p15gui/examples/events.png}
}
...
\fr{Uso delle finestre di dialogo}{
   ...
   \backpick{4cm}{-1.8cm}{-1.3cm}{15/img/dialogs.png}
}
...
\fr{WindowBuilder: un plugin per Eclipse}{
    \fg{height=0.75\textheight}{15/img/builder.png}
}
...
\fr{MVC con le GUI: un esempio di struttura}{
    \fg{height=0.55\textheight}{15/p15gui/mvc/MVC-abstract.png}
...
\fr{Un esempio di applicazione}{
    \fg{height=0.65\textheight}{15/img/person-editor.png}
}
...
\fr{UML più dettagliato}{
    \vspace{-20pt}\fg{height=0.8\textheight}{15/p15gui/mvc/MVC.png}
}
...
\fr{Diagramma delle classi}{
    \fg{height=0.55\textheight}{15/p15gui/events/events.png}
