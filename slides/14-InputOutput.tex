...
\title[OOP14: I/O]{14 \\ Input-Output}

\begin{document}

\newcommand{\ecl}{\eclipsepath{p14io}}
...
\fr{La libreria \Cil{java.io}}{
    \fg{height=0.85\textheight}{14/img/io.png}
}
...
\fr{Classe \Cil{java.io.File}: pt1}{
    \sizedrangedcode{\ssmall}{1}{28}{14/short/File.java}
}	

\fr{Classe \Cil{java.io.File}: pt2}{
    \sizedrangedcode{\ssmall}{30}{100}{14/short/File.java}
}	
...
getName prova.bin
getParent /home/mirko/aula/14
isAbsolute true
getCanonicalPath /home/mirko/aula/14/prova.bin
getPath /home/mirko/aula/14/prova.bin
getParentFile /home/mirko/aula/14
getAbsolutePath /home/mirko/aula/14/prova.bin
getAbsoluteFile /home/mirko/aula/14/prova.bin
getCanonicalFile /home/mirko/aula/14/prova.bin
canRead true
canWrite true
isDirectory false
isFile true
...
\fr{La classe \Cil{java.io.InputStream}}{
    \sizedcode{\scriptsize}{14/short/InputStream.java}
}	

\fr{\Cil{FileInputStream} e \Cil{ByteArrayInputStream}}{
    \fg{height=0.85\textheight}{14/img/bytefile.png}
}
...
\fr{La classe \Cil{java.io.OutputStream}}{
    \sizedcode{\scriptsize}{14/short/OutputStream.java}
...
\fr{Decorazione, in generale}{
    \fg{height=0.85\textheight}{14/img/decorator.png}
}

\fr{Decorazione, il caso di \Cil{DataInputStream}}{
    \fg{height=0.85\textheight}{14/img/dec.png}
}

\fr{\Cil{DataInputStream}}{
    \sizedrangedcode{\ssmall}{1}{100}{14/short/DataInputStream.java}
}

\fr{\Cil{DataOutputStream}}{
    \sizedrangedcode{\ssmall}{1}{100}{14/short/DataOutputStream.java}
}
...
\fr{Decorazione, una visione complessiva}{
    \fg{height=0.85\textheight}{14/img/dec-all.png}
}
...
\fr{Diagramma UML con \Cil{ObjectInputStream}}{
    \fg{height=0.85\textheight}{14/img/object.png}
}
...
\fr{Serializzazione ad-hoc per \Cil{java.util.ArrayList}, pt1}{
    \sizedrangedcode{\ssmall}{1}{23}{14/short/ArrayList.java}
}

\fr{Serializzazione ad-hoc per \Cil{java.util.ArrayList}, pt2}{
    \sizedrangedcode{\ssmall}{25}{100}{14/short/ArrayList.java}
}
...
\fr{Classe \Cil{RandomAccessFile}}{
    \fg{height=0.85\textheight}{14/img/random.png}
}
...
\fr{UML classi relative ai reader (writer analoghi)}{
    \fg{height=0.85\textheight}{14/img/text.png}
}
