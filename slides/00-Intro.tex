...
\frs{5}{Docenti}{
  ...
  %  \iz{ 
  %    \item e-mails | \texttt{\{simone.costanzi2,luca.tremamunno\}@unibo.it}
  %  }
  %}
}
...
\frs{15}{Software}{
  \bl{Java}{\iz{ 
  \item OpenJDK 17 (Open Java Development KIT){\iz{
    \item \myurl{https://adoptium.net/}
    }}
  \item Visual Studio Code + Java plugin, e correlati
strumenti:{\iz{
      \item Git,
      \item Gradle
      \item (Eclipse IDE usabile eventualmente)
  }}}}
