...
\title[OOP10: Collezioni]{10 \\ Java Collections Framework}
...
\fr{JCF -- struttura complessiva}{
  \fg{height=0.75\textheight}{10/img/tax1.png}
}
...
\fr{Interfacce per l'iterazione}{
  \sizedcode{\scriptsize}{10/code/short/Iterable.java}
  \sizedcode{\scriptsize}{10/code/short/Iterator.java}
  \sizedcode{\scriptsize}{10/code/short/Collection-Short.java}
}

\fr{Interfacce per l'iterazione -- UML}{
  \fg{height=0.7\textheight}{10/img/uml-iter.pdf}
}
...
%  \sizedcode{\ssmall}{10/code/iterator/AltRange.java}
%}
...
\fr{\Cil{Collection}}{
  \sizedcode{\ssmall}{10/code/short/Collection.java}
}
...
\fr{\Cil{Set} e \Cil{List}}{
  \sizedcode{\scriptsize}{10/code/short/List.java}
  \sizedcode{\scriptsize}{10/code/short/Set.java}
}

\fr{\Cil{ListIterator}}{
  \sizedcode{\scriptsize}{10/code/short/ListIterator.java}
}
...
\section{Implementazioni di \cil{Set}}
...
\fr{Costruttori di \Cil{HashSet}}{
  \sizedcode{\scriptsize}{10/code/short/HashSet.java}
}

\frs{5}{\Cil{equals()} e \Cil{hashCode()}}{
...
\fr{Comparazione ``interna'' agli elementi}{
  \sizedcode{\scriptsize}{10/code/short/Comparable.java}
  \sizedcode{\scriptsize}{10/code/Wrappers.java}
  \sizedcode{\scriptsize}{10/code/SortedPersona.java}
}
...
\fr{Interfacce \Cil{SortedSet} e \Cil{NavigableSet}}{
  \sizedcode{\scriptsize}{10/code/short/SortedSet.java}
  \sizedcode{\scriptsize}{10/code/short/NavigableSet.java}
}
...
\fr{Costruttori di \Cil{TreeSet}, e comparatore ``esterno''}{
  \sizedcode{\scriptsize}{10/code/short/TreeSet.java}
  \sizedcode{\scriptsize}{10/code/short/Comparator.java}
}
