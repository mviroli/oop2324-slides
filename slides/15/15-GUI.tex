...
\fr{Lavorare incapsulando il frame dietro una interfaccia}{
   ...
   \bl{Tipica tecnica}{\iz{
    \item si disegni una \cil{interface} per la GUI che non menziona Swing
    \item i dettagli implementativi al solito siano delegati ad una classe che implementa, e che si compone di un \cil{JFrame}
   }}
}
