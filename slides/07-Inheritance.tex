...
\fr{Scenari di riuso ed estensione}{
  \bx{\iz{
    ...
    \item Data una classe, crearne una più specializzata (ad esempio, più robusta e sicura anche se meno prestante, o viceversa, più prestante)
...
\fr{Notazione UML per l'estensione}{
  ...
  \fg{width=0.45\textwidth}{07/img/uml-ext.pdf}
}

\fr{Notazione UML -- versione semplificata per il design}{
  \fg{width=0.4\textwidth}{07/img/uml-ext2.pdf}
}
...
\fr{Notazione UML}{
  ...
  \fg{height=0.6\textheight}{07/img/uml-ext3.pdf}
}
...
\fr{Campi \Cil{protected}? Meglio di no...}{
    ...
    \bl{Best practice}{\iz{
        ...
        \item Se l'accesso in lettura o scrittura è necessario solo nell sottoclasse, allora utilizzare getter o setter \cil{protected}
    }}
}
...
\fr{Diagramma UML complessivo}{
  \fg{height=0.8\textheight}{07/img/uml-domus.pdf}
}
...
\fr{Esempio gestione memoria: stack/heap/vtables}{
  \fg{height=0.8\textheight}{07/img/layout.pdf}
}
