...
\fr{Scenari di riuso (estensione, sostituibilità)}{
  \bx{\iz{
    ...
    \item La nuova classe potrebbe dover essere sostituibile alla precedente{\iz{
        ...
        \item ad esempio, data la classe \cil{Vehicle}, potrei poi creare le classi \cil{Car}, \cil{Truck}, \cil{Boat}
    }}
  }}
}
...
\fr{Riuso via composizione}{
  ...
  \bl{Possibile design}{\iz{
    \item interfaccia \cil{Counter}, implementazione \cil{CounterImpl}, e poi \cil{MultiCounterImpl} che implementa \cil{Counter} e si compone di un \cil{CounterImpl}
  }}
}

\fr{Interfaccia \Cil{Counter} e classe \Cil{UseMultiCounter}}{
  \srcode{\scriptsize}{3}{32}{\ecl/composition/Counter.java}
