...
\centering
  ...
  \bl{Tutors: Ing. Martina Baiardi e Ing. Nicolas Farabegoli}{\dots}
}
...
\frs{15}{Software}{
  ...
  \onslide<2>{\alert{No Generative Artificial Intelligence here! (GPT, Bard, Copilot,\dots)}}
}
...
\fr{Sul ruolo di questo corso, a.k.a. ``Programmazione 2''}{
    ...
    \item Curriculum (progetti software, Java, OOP moderna, \dots, C\#)
