...
\newcommand{\ecl}{\idepath{p10collections}}
...
\frs{5}{\Cil{equals()} e \Cil{hashCode()}}{
  ...
  \bl{Quale funzione di hashing?}{\iz{
    ...
    \item Eclipse/VSCode forniscono la generazione di un \cil{hashCode} (e \cil{hashCode}) ragionevoli (ce ne sono di migliori: \texttt{djb2}, \texttt{murmur3})
  }}
}

\fr{Esempio: \Cil{Person} pt.1}{
  \sizedrangedcode{\scriptsize}{5}{28}{\ecl/set/Person.java}
}

\fr{Esempio: \Cil{Person} pt.2}{
  \sizedrangedcode{\scriptsize}{29}{100}{\ecl/set/Person.java}
}

\fr{\Cil{UseHashSetPerson}}{
  \sizedrangedcode{\scriptsize}{5}{100}{\ecl/set/UseHashSetPerson.java}
}
...
\fr{Comparazione ``interna'' agli elementi}{
  ...
  \sizedcode{\scriptsize}{code/SortedPerson.java}
}
...
\fr{\Cil{UseTreeSetPerson}: comparazione interna}{
  \sizedrangedcode{\ssmall}{5}{100}{\ecl/sortedset/UseTreeSetPerson.java}
}
...
\fr{Definizione di un comparatore esterno}{
  \sizedrangedcode{\scriptsize}{3}{100}{\ecl/sortedset/PersonComparator.java}
}

\fr{\Cil{UseTreeSetPerson2}: comparazione esterna}{
  \sizedrangedcode{\ssmall}{3}{100}{\ecl/sortedset/UseTreeSetPerson2.java}
}
