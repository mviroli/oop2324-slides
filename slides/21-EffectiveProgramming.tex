...
\newcommand{\ecl}{\eclipsepath{p21effective}}
...
\frs{1}{DIP | Dependency Inversion Principle}{
  ...
  \centering\includegraphics[width = 0.35\textwidth]{21/img/DIP1.png}~
  \includegraphics[width = 0.6\textwidth]{21/img/DIP2.png}
}
...
\frs{5}{Creating and destroying objects: costruttori privati}{
    ...
    \bl{Esempio}{
  \sizedrangedcodet{\ssmall}{1}{100}{21/Collections.java}
  }
}
