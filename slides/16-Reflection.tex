...
\title[OOP16: Reflection]{16 \\ Reflection \\ e informazioni run-time sui tipi, annotazioni e testing}

\begin{document}

\newcommand{\ecl}{\eclipsepath{p16reflection}}
...
\fr{Il classfile}{
  \bl{Classi e JVM}{\iz{
    ...
    \item Il contenuto informativo del \texttt{.class} è desunto (per compilazione) da quello del \texttt{.java}, solo espresso in un linguaggio diverso che garantisce la correttezza del contenuto e le performance di chi deve leggerlo
  }}
...
\fr{Contenuto del classfile (1/2)}{
  \sizedcode{\tiny}{16/code/loading/out_1.txt}
}

\fr{Contenuto del classfile (2/2)}{
  \sizedcode{\tiny}{16/code/loading/out_2.txt}
}
...
\fr{Alcuni metodi di \Cil{java.lang.Class}}{
    \sizedcode{\tiny}{16/code/api/Class.java}
}

\fr{Alcuni metodi di \Cil{java.lang.reflect.Field}}{
    \sizedcode{\ssmall}{16/code/api/Field.java}
}

\fr{Alcuni metodi di \Cil{java.lang.reflect.Constructor}}{
    \sizedcode{\ssmall}{16/code/api/Constructor.java}
}

\fr{Alcuni metodi di \Cil{java.lang.reflect.Method}}{
    \sizedcode{\ssmall}{16/code/api/Method.java}
}
...
\fr{Caricamento ed esecuzione automatica}{
    %\sizedcode{\ssmall}{16/code/example/DynamicExecution.java}
...
\fr{Classi di prova}{
    \sizedcode{\scriptsize}{16/code/string/Person.java}
    \sizedcode{\scriptsize}{16/code/string/Teacher.java}
}
...
\fr{Esempio \Cil{@Override}}{
    \sizedrangedcode{\footnotesize}{1}{50}{16/code/annotations/A.java}
}
...
\fr{Esempio \Cil{@SuppressWarnings}}{
    \sizedrangedcode{\ssmall}{1}{50}{16/code/annotations/Vector.java}
}
...
\fr{Classe per il collaudo di un contatore}{
    \sizedrangedcode{\ssmall}{1}{50}{16/code/junit/CounterTest.java}
}
