...
\title[OOP17: Stream funzionali]{18 \\ Stream funzionali}

\begin{document}

\newcommand{\ecl}{\eclipsepath{p18streams}}
...
\frs{5}{Il concetto di Stream}{
  \bl{Idee}{\iz{
    ...
    \item Questa modalità di lavoro rende moslte computazioni (automaticamente) parallelizzabili, ossia computabili da un set arbitrario di Thread
  }}
}
...
\fr{Collettori di libreria: la classe \Cil{Collectors}}{
    \sizedrangedcodet{\tiny}{1}{100}{17/snippets/Collectors.java}
}
