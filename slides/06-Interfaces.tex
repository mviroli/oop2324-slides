...
\fr{Notazione UML completa per la classe \Cil{Lamp}:\\ tipicamente usata in fase di implementazione}{
  \fg{height=0.8\textheight}{06/img/lamp1.pdf}
}

\fr{Notazione parziale: solo parte pubblica:\\ tipicamente usata in fase di design}{
  \fg{height=0.6\textheight}{06/img/lamp2.png}
}

\fr{UML: \Cil{Lamp} e \Cil{TwoLampsDevice}}{
  \fg{height=0.5\textheight}{06/img/lamp3.png}
}
...
\fr{UML: \Cil{Lamp} e \Cil{LampsRow}}{
  \fg{height=0.45\textheight}{06/img/lamp4.png}
}

\fr{Scenario \Cil{DomusController}}{
  \fg{height=0.65\textheight}{06/img/lamp5.png}
...
\fr{Realizzazione senza riuso: schema}{
  \srcode{\tiny}{1}{100}{06/code/DomusControllerTry.java}
}
...
\fr{Interface \Cil{Device}}{
  %\sizedcode{\normalsize}{06/code/Device.java}
  \srcode{\small}{3}{30}{\ecl/domo/Device.java}
}

\fr{Implementazioni di \Cil{Device}}{
  \sizedcode{\scriptsize}{06/code/DeviceB.java}
}
...
\fr{Notazione UML per le interfacce}{
  ...
  \fg{width=0.7\textwidth}{06/img/uml-int.pdf}
}
...
\fr{Interfacce e assegnamenti}{
  \sizedcode{\footnotesize}{06/code/DueTipi.java}
}

\fr{Ridurre la molteplicità / aumentare riuso -- prima}{
  \sizedcode{\scriptsize}{06/code/IntMethod.java}
}

\fr{Ridurre la molteplicità / aumentare riuso -- dopo}{
  \sizedcode{\scriptsize}{06/code/IntMethod2.java}
}
...
\fr{Scenario \Cil{DomusController} rivisitato}{
  \fg{height=0.65\textheight}{06/img/uml-int-domus.pdf}
}
...
\fr{Uso di \Cil{DomusController}}{
  %\sizedcode{\scriptsize}{06/code/classes2/UseDomusController.java}
...
\fr{Polimorfismo e interfacce}{
  ...
  \fg{height=0.4\textheight}{06/img/uml-int-general.pdf}
}


\fr{Late binding (o dynamic binding)}{
  \sizedcode{\scriptsize}{06/code/IntMethod3.java}
...
\fr{Early (static) vs late (dynamic) binding}{
  \sizedcode{\ssmall}{06/code/EarlyLate.java}
  \bl{Differenze}{\iz{
...
\fr{Esempio \Cil{Device} e \Cil{Luminous}}{
  \sizedcode{\scriptsize}{06/code/Multi.java}
}
...
\fr{Esempio \Cil{LuminousDevice}}{
  \sizedcode{\scriptsize}{06/code/Multi2.java}
}
