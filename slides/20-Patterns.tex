...
\newcommand{\ecl}{\eclipsepath{p20patterns}}
\newcommand{\ecllambda}{\eclipsepath{p17lambda}}
...
\fr{Il caso di MVC -- schema generale (nomi di comodo)}{
    \fg{height=0.55\textheight}{20/img/MVC-abstract.png}
}
...
\frs{5}{Principi di qualità di programmi object-oriented}{
...
%    \fg{height=0.85\textheight}{20/img/classification.png}
%}
...
\fr{Proxy: UML}{
    \fg{height=0.5\textheight}{20/img/proxy.png}
}
...
\fr{Singleton: UML}{
    \fg{height=0.5\textheight}{20/img/singleton.jpg}
}
...
\fr{Template Method: UML}{
    \fg{height=0.5\textheight}{20/img/template_method.jpg}
}
...
\fr{Strategy: UML}{
    \fg{height=0.3\textheight}{20/img/strategy.jpg}
}
...
\fr{Decorator: UML}{
    \fg{height=0.4\textheight}{20/img/decorator.jpg}
}
...
\fr{Iterator: UML}{
    \fg{height=0.4\textheight}{20/img/iterator.png}
}
...
\fr{Observer: UML}{
    \fg{height=0.5\textheight}{20/img/observer.jpg}
}
...
\fr{Adapter: UML}{
    \fg{height=0.4\textheight}{20/img/adapter2.jpg}
    \bl{Varianti}{\iz{
...
\fr{Static e Simple Factory}{
  \fg{width=0.8\textheight}{20/img/fac1.png}
  \fg{height=0.6\textheight}{20/img/fac2.png}
}
...
\fr{Factory Method e Abstract Factory}{
  \fg{width=0.8\textheight}{20/img/fac3.png}
  \fg{width=0.8\textheight}{20/img/fac4.png}
}
...
\fr{Factory Method: UML}{
    \fg{height=0.45\textheight}{20/img/factorymethod.png}
}
...
\fr{Builder: UML}{
    \fg{height=0.45\textheight}{20/img/builder.png}
}
