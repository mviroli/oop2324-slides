...
\begin{center}\includegraphics[height=0.6\textheight]{05/img/coupling.png}\end{center}
}
...
\fr{Parte pubblica della classe \Cil{Lamp}}{
  \sizedcode{\footnotesize}{05/code/IntLamp.java}
}
...
\fr{Prima versione Classe Lamp}{
  \sizedcode{\tiny}{05/code/Lamp1.java}
}
...
\fr{Classe UseLamp}{
  ...
  %\sizedcode{\footnotesize}{05/code/classes/UseLamp.java}
}
...
\fr{UseLamp: uso di toString}{
  ...
  \sizedcode{\scriptsize}{05/code/classes/UseLampString.txt}
}
...
\fr{Getter/setter in Lamp}{
  \sizedcode{\ssmall}{05/code/LampGS.java}
}
