...
\frs{10}{L'ecosistema dei linguaggi di programmazione}{
  ...
  \bl{Il caso dei linguaggi dinamici\dots}{\iz{
    \item Python, Ruby, JavaScript: orientati a scripting
    \item molto diffusi in applicazioni Web, machine learning,\dots
  }}
}
...
\frs{5}{Qualche nota introduttiva..}{
  \bl{Java}{\iz{
    ...
    \item \dots Python (in crescita), C, Java sono gli unici sopra al 10\%
  }}
